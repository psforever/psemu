...
#include "common/packet/CharacterInfoMessage.h"
#include "common/packet/CharacterRequestMessage.h"
#include "common/packet/ConnectToWorldMessage.h"
#include "common/packet/ConnectToWorldRequestMessage.h"
#include "common/packet/ControlSync.h"
#include "common/packet/ControlSyncResp.h"
#include "common/packet/ClientChallengeXchg.h"
#include "common/packet/ClientFinished.h"
#include "common/packet/ClientStart.h"
#include "common/packet/KeepAliveMessage.h"
#include "common/packet/LoadMapMessage.h"
#include "common/packet/LoginMessage.h"
#include "common/packet/LoginRespMessage.h"
#include "common/packet/ObjectCreateMessage.h"
#include "common/packet/opcodes.h"
#include "common/packet/pkt_header.h"
#include "common/packet/ServerChallengeXchg.h"
#include "common/packet/ServerFinished.h"
#include "common/packet/ServerStart.h"
#include "common/packet/SetCurrentAvatarMessage.h"
#include "common/packet/SlottedMetaAck.h"
#include "common/packet/SlottedMetaPacket.h"
#include "common/packet/VNLWorldStatusMessage.h"
...
void encodeHeaderEncrypted(BitStream& bitStream) {
    ...
    unsigned char paddingForEncryptAlign = 0x00;
    bitStream.write(&paddingForEncryptAlign);
}

void encryptAndSend(Server& server, std::vector<unsigned char>& data, std::shared_ptr<Session> session) {
    ...
    std::vector<unsigned char> sendBufFinal;
...
void handleControlPacket(Server& server, BitStream& bitStream, std::shared_ptr<Session> session) {
    ...
    bitStream.deltaPos(8 * sizeof(unsigned char));
...
void generateToken(const std::string username, const std::string password, std::array<unsigned char, 16>& token) {
...
void handleGamePacketWorld(Server& server, BitStream& bitStream, std::shared_ptr<Session> session) {
    ...
    case OP_ConnectToWorldRequestMessage: {
        ...
        std::vector<unsigned char> objectHexCopy = objectHex;
        encryptAndSend(server, objectHexCopy, session);

        std::vector<unsigned char> hardcodedStuff = { 0x14, 0x0F, 0x00, 0x00, 0x00, 0x10, 0x27, 0x00, 0x00, 0xC1, 0xD8, 0x7A, 0x02, 0x4B, 0x00, 0x26, 0x5C, 0xB0, 0x80, 0x00 };
    ...
    case OP_CharacterRequestMessage: {
        ...
        case CharacterRequestMessage::CRA_Select: {
            ...
            objectHexBitStream.deltaPos(8 * sizeof(unsigned char));
