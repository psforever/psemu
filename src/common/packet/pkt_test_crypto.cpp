...
void testClientChallengeXchg() {
    static std::vector<uint8_t> encodedBuf = std::vector<uint8_t>({
        0x01, 0x01, 0x96, 0x2D, 0x84, 0x53, 0x24, 0xF5, 0x99, 0x7C, 0xC7, 0xD1, 0x60, 0x31, 0xD1, 0xF5,
        0x67, 0xE9, 0x00, 0x01, 0x00, 0x02, 0xFF, 0x24, 0x00, 0x00, 0x10, 0x00, 0xF5, 0x75, 0x11, 0xEB,
        0x8E, 0x5D, 0x1E, 0xFB, 0x8B, 0x7F, 0x32, 0x87, 0xD5, 0xA1, 0x8B, 0x17, 0x10, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00,
        0x01, 0x03, 0x07, 0x00, 0x00, 0x00
    });
...
void testClientFinished() {
    static std::vector<uint8_t> encodedBuf = std::vector<uint8_t>({
        0x10, 0x10, 0x00, 0xED, 0xDC, 0x35, 0xF2, 0x52, 0xB0, 0x2D, 0x0E, 0x49, 0x6B, 0xA2, 0x73, 0x54,
        0x57, 0x8E, 0x73, 0x01, 0x14, 0xEA, 0x3C, 0xF0, 0x5D, 0xA5, 0xCB, 0x42, 0x56, 0x8B, 0xB9, 0x1A,
        0xA7
    });
...
void testServerChallengeXchg() {
    static std::vector<uint8_t> encodedBuf = std::vector<uint8_t>({
        0x02, 0x01, 0x96, 0x2D, 0x84, 0x53, 0x1B, 0x0E, 0x64, 0x08, 0xCD, 0x93, 0x5E, 0xC2, 0x42, 0x9A,
        0xEB, 0x58, 0x00, 0x01, 0x03, 0x07, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x10, 0x00, 0x51, 0xF8, 0x3C,
        0xE6, 0x45, 0xE8, 0x6C, 0x3E, 0x79, 0xC8, 0xFC, 0x70, 0xF6, 0xDD, 0xF1, 0x4B, 0x0E
    });
...
void testServerFinished() {
    static std::vector<uint8_t> encodedBuf = std::vector<uint8_t>({
        0x01, 0x14, 0xD6, 0x4F, 0xFB, 0x8E, 0x52, 0x63, 0x11, 0xB4, 0xAF, 0x46, 0xBE, 0xCE
    });
